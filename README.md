...
# OUTPUT:
<img width="1150" height="259" alt="image" src="https://github.com/user-attachments/assets/74335ea5-605e-411b-9a59-82e72671586d" />
...
# OUTPUT:
<img width="1089" height="308" alt="image" src="https://github.com/user-attachments/assets/ecaeb376-36cc-4991-ac62-36d5e7235dbc" />
...
# OUTPUT:
<img width="1082" height="472" alt="image" src="https://github.com/user-attachments/assets/e468ace9-3f5a-4448-9fe4-7371185a5289" />

# RESULT:
Thus, the program is verified successfully.

# EXP NO: 3d) C PROGRAM TO FIND THE SMALLEST ELEMENT IN THE GIVEN ARRAY: int arr[]={12,1234,45,67,1}

# AIM:
To write a C program to find the smallest element in the given array: int arr[] = { 12, 1234, 45, 67, 1 }
...
# OUTPUT:
<img width="1120" height="257" alt="image" src="https://github.com/user-attachments/assets/749aefd0-0178-44f8-9182-548f99faba42" />

# RESULT:
Thus, the program is verified successfully.

# EXP NO: 3e) C PROGRAM TO PRINT THE FOLLOWING PATTERN5 
...
# OUTPUT:
<img width="1118" height="439" alt="image" src="https://github.com/user-attachments/assets/f45c64ce-9860-43e5-a32d-75a68f60d92c" />
